...
class ExcelSheetRenameEdit(object):
	...
	def event_gainFocus(self):
		...
		global _isRenamingSheet
		if not _isRenamingSheet:
			_isRenamingSheet = True
	...
	def _show_rename_dialog(self, initial_name, hwnd):
		...
		# Translators: Dialog text prompting the user to enter a new sheet name.
		...
		def _do_enter(clean_name, old_clip):
			...
			import ui
			# Translators: Message announcing the sheet is being renamed.
	...
	def _get_name(self):
		...
		"""
		# Translators: The script description for renaming a sheet.
